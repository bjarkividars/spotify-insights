...
import { handleSpotifyAuth } from "./actions";

interface LoginFormProps {
  isReturningVisitor: boolean;
}

export function LoginForm({ isReturningVisitor }: LoginFormProps) {
  const [state, formAction, isPending] = useActionState(handleSpotifyAuth, null);
